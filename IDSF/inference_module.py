...
class JointBertTools:
    ...
    def load_model(self):
        ...
        try:
            ...
            # ! because of saving model is in different directory so, need to train again
            # ! training_args.bin is used to save args of model including model_type, model_dir, etc.
